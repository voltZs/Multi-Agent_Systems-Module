...
public class Auctioneer extends Agent {
	...
	protected void setup() {
		...
		catalogue = CSVReader.readCSV(csvPath.getAbsolutePath());
	...
	private class AuctionProcess extends SimpleBehaviour {
		...
		public void action() {
			...
			for(String[] item : catalogue) {
				...
				currentPrice = Integer.parseInt(item[1]);
				itemDescription = item[0];
				System.out.println("Price initialised at " + currentPrice);
...
//	 				while # of replies < # bidders - making sure we get a reply from everyone
					...
					if(bidsCnt < 2){
						System.out.println("Less than 2 bids, moving on...");
						noMoreBids = true;
					}
